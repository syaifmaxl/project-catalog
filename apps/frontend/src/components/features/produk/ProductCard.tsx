    ...
    <div className="group relative bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-gray-200">
      ...
      >
        {discount && (
          ...
          >
            <div className="relative">
              <div
                className={`bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full font-bold shadow-lg ${
                  compact ? "px-2 py-1 text-xs" : "px-3 py-1.5 text-xs"
                }`}
              >
                {discount}% OFF
              </div>
              <div className="absolute inset-0 bg-gradient-to-r from-red-400 to-red-500 rounded-full blur-sm opacity-50 -z-10" />
            </div>
          </div>
        )}
        ...
        {isLimited && (
          ...
          >
            <div
              className={`bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-full font-semibold flex items-center gap-1 shadow-lg ${
        ...
        <button
          ...
          className={`absolute z-20 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white hover:scale-110 transition-all duration-300 ${
      ...
      <div className={`relative space-y-3 ${compact ? "p-3" : "p-5"}`}>
        ...
        <h3
          className={`font-semibold text-gray-900 leading-tight line-clamp-2 group-hover:text-amber-700 transition-colors duration-300 ${
        ...
        <div className={`flex pt-2 ${compact ? "gap-1" : "gap-2"}`}>
          ...
          <button
            ...
            className={`border-2 border-amber-200 hover:border-amber-300 text-amber-700 hover:text-amber-800 rounded-lg font-semibold transition-all duration-300 hover:bg-amber-50 ${
